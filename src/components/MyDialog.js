...
const MyDialog = (props) => {
    ...
    const sameZones = () => {
        return fromZone === toZone && fromZone !== '' && toZone !== '' ? true : false
    }
        ...
        <div>
            ...
            <DialogActions>
                ...
                <div className={classes.button}>
                    <Tooltip title="From-Zone & To-Zone are normally different. Are You Sure?" placement={'top'}>
                        <Badge badgeContent={1} color="secondary">
                            <PriorityHighIcon colour="primary"/>
                        </Badge>
                    </Tooltip>
                </div>
                :
                ...
                <Button
                    ...
                    className={classes.button}
                    startIcon={<FileCopyIcon />}
                    onClick={() => saveRule({copy: true, edit: edit, close: false})}
